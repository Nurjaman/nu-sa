					...
					<div class="col-sm-12">
						<form action="update_format_wa.php" method="POST" onsubmit="return confirm('Anda yakin akan mengupdate format WA?')" >
							...
							<label>
								...
								<br>Contoh: Kepada YTH. [VAR_1], yang berada di [VAR_2] kami mengundang ke acara pernikahan kami yang dilaksanakan di Jl. Gerhana No.2, Cirangrang, Kec. Babakan Ciparay, Kota Bandung, Jawa Barat 40227. Pada Tanggal 18 - 12 - 2022. Terima Kasih. https://nu-sa.my.id
							</label>
